...
-(void) calculateTexCoordsSteps
{
   float pixelWidth = [[textureAtlas texture] pixelsWide];
   float pixelHeight = [[textureAtlas texture] pixelsHigh];
	texStepX = itemWidth / pixelWidth;
	texStepY = itemHeight / pixelHeight; 	
}
