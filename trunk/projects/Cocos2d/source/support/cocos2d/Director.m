...
-(void) replaceScene: (Scene*) scene
{
	...
	NSUInteger sceneIndex = [scenesStack_ count];

	[scenesStack_ replaceObjectAtIndex:sceneIndex-1 withObject:scene];
...
- (void)setAnimationInterval:(NSTimeInterval)interval
{
   (void)interval;
	...
	twlog("FastDirectory doesn't support setAnimationInterval, yet");
}
@end
